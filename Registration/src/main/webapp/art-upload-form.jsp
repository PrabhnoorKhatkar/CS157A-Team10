...
<body>
	...
	<form action="UploadArtwork" method="post" class="upload-form">
		...
		<textarea id="description" name="description" placeholder="Describe your artwork" required></textarea>
		...
		<input type="number" id="startingPrice" name="startingPrice" placeholder="e.g., 500" min="0" required>

		<!-- AUCTION DURATION IN HOURS -->
		<label for="duration">Auction Duration (hours):</label> 
		<input type="number" id="duration" name="duration" placeholder="Enter duration in hours" min="1" required>

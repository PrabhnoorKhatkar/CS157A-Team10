...
<jsp:useBean id="orderDetails" scope="request" type="artauction.order.OrderDetails"/>
	...
	<body>
		<div class="order-confirmation">
			<div class="order-info">
				...
				<p>Hey ${name}, your order for "${artwork.title}" has been placed.</p>
			
				<p>Email: ${email}</p>

				<p>Tracking Number: ${orderDetails.tracking}</p>
